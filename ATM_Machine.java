...
{	
    ...
    public void signup()  // This method is used to register the user 
    {
        Scanner scan = new Scanner(System.in);		// Takes input from the user
    ...
    public boolean login()   // This method is used to login the user
    {
    ...
    public void withdraw()  // This method is used to withdraw the money
    {
    ...
    public void deposit() // This method is used to deposit the money
    {
    ...
    public void transfer()  // This method is used to transfer the money 
    {
        Scanner scan = new Scanner(System.in);
    ...
    public void transactionHistory() // This method is used to view the transaction history
    {
        if (transaction == 0)
        {
            System.out.println("\nEmpty");
